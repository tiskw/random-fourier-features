...
def parse_args():
    ...
    parser.add_argument("--kstd", metavar="FLOAT", type=float, default=0.10,
                        help="standard deviation of random kernel matrix")
    parser.add_argument("--estd", metavar="FLOAT", type=float, default=0.10,
...
def main(args):
    ...
    gpc = model_classes[args.rtype](dim_kernel=args.kdim, std_kernel=args.kstd, std_error=args.estd)
