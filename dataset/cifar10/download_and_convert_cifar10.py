...
### If archive of the CIFAR10 is not exists, this funcion will download the archive from official website automatically.
def create_dataset(filepath):
    ...
    ### and the following code extract only data files, un-pickle and store them as dictionaly format.
